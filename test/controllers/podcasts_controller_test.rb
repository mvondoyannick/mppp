...
class PodcastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create podcast" do
    assert_difference('Podcast.count') do
      post podcasts_url, params: { podcast: { content: @podcast.content, date_creation: @podcast.date_creation, title: @podcast.title } }
    end
  ...
  test "should update podcast" do
    patch podcast_url(@podcast), params: { podcast: { content: @podcast.content, date_creation: @podcast.date_creation, title: @podcast.title } }
